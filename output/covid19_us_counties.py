...
df = df[df['cases'] > 30] # retain only rows with 'cases' greater than 10
df = df.reset_index()

df.to_csv("covid19_us_counties_nytimes.csv")
...
fig = px.choropleth_mapbox(df, 
                title="Progression of COVID-19 cases across US counties",
                geojson=counties, 
                locations='fips', 
                color='cases',
